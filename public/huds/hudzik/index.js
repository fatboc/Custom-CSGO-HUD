const COLOR_T = "rgba(255, 166, 0, 1.0)";
const COLOR_CT = "rgba(0, 127, 255, 1.0)";
const COLOR_NEW_T = "rgba(255, 191, 0, 1.0)";
const COLOR_NEW_CT = "rgba(0, 187, 255, 1.0)";
// const GRADIENT_T = "linear-gradient(90deg, rgba(255,166,0,1) 20%, rgba(255,220,40,1) 50%, rgba(255,166,0,1) 80%);"
// const GRADIENT_CT = "background: linear-gradient(90deg, rgba(0,127,255,1) 20%, rgba(25,200,255,1) 50%, rgba(0,127,255,1) 80%);"
const COLOR_RED = "rgba(242, 34, 34, 1.0)";
const COLOR_MAIN_PANEL = "rgba(12, 15, 18, 0.7)";
const COLOR_SUB_PANEL = "rgba(12, 15, 18, 0.5)";
...
const DEV_PURPLE = "rgba(0, 220, 255, 1.0)";
...
console.log(health_color);
  let gradient_single = "linear-gradient(to " + side.substr(8) + ", rgba(0,0,0,0) " + (100 - stats.health) + "%, " + alt_health_color + " " + (100 - stats.health) + "%, " + health_color + " " + (100 - (stats.health/2)) + "%)";
